...
class Component {
  static ThemeData theme() {
    return ThemeData(
      ...
      bottomSheetTheme: BottomSheetThemeData(backgroundColor: Colors.white, modalBackgroundColor: Colors.white, modalBarrierColor: Colors.white),
      colorScheme: ColorScheme.fromSwatch().copyWith(primary: ColorPalette.primary, secondary: ColorPalette.secondary.withAlpha(100)).copyWith(surface: Color(0xffF7F7F7)),
    );
  }
  ...
  static AppBar appbar(String title) => AppBar(
        elevation: 0,
        centerTitle: false,
        title: Text(title, style: ComponentTyphography.titleMedium()!.copyWith(color: ColorPalette.white)),
  ...
  static AppBar appBarBackground(String title, {List<Widget>? actions}) => AppBar(
        elevation: 0,
        centerTitle: false,
        title: Text(title, style: ComponentTyphography.titleMedium()!.copyWith(color: ColorPalette.white)),
        flexibleSpace: const ClipRRect(
  ...
  static Widget buttonClose({String? label, Object? result}) => InkWell(
        ...
        child: Container(
          ...
          child: Component.textDefault(label ?? "Mengerti", colors: ColorPalette.white, textAlign: TextAlign.center, fontSize: 12),
        ),
      );
  ...
  static TextStyle textStyle() => TextStyle(fontSize: 13.0, color: ColorPalette.blackText);

  static divider({double height = 5.0, Color color = ColorPalette.greyBorder, double thickness = 1}) => Padding(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Component.textDefault("Fitur sedang dalam tahap pengembangan", fontSize: 12),
        ],
      ),
    );
  }
